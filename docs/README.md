# Documentación Manta360

Índice de artefactos para la rúbrica de **Desarrollo de Sistemas de Información** (PUCE Manabí).

| Documento | Contenido |
|-----------|-----------|
| [arquitectura.md](./arquitectura.md) | Diagrama de arquitectura, capas y metodología |
| [modelo-datos.md](./modelo-datos.md) | DER / modelo relacional (Mermaid) |
