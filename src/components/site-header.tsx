        ...
        <nav className="flex items-center gap-3 text-sm font-semibold text-slate-600">
          {session ? (
            ...
            <>
              ...
              <Link href="/registro" className="landing-primary rounded-md px-4 py-2.5 text-white shadow-sm transition focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-sky/25">Crear cuenta</Link>
            </>
          )}
        </nav>
      </div>
